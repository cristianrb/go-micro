...
func NewUsersService(pool *sql.DB) *UserRepositoryImpl {
...
func (u *UserRepositoryImpl) GetOne(id int) (*User, error) {
	ctx, cancel := context.WithTimeout(context.Background(), dbTimeout)
	defer cancel()
...
func (u *UserRepositoryImpl) ResetPassword(password string, user User) error {
	ctx, cancel := context.WithTimeout(context.Background(), dbTimeout)
	defer cancel()
...
func (u *UserRepositoryImpl) PasswordMatches(plainText string, user User) (bool, error) {
